...
public sealed class Config
{
    ...
    /// <summary>
    /// Creates a new instance of the <see cref="Config"/> class from the JSON text.
    /// </summary>
    /// <param name="json">JSON text to parse.</param>
    /// <param name="options">Options to control the behavior during parsing.</param>
    /// <returns>A <see cref="Config"/> instance representing the JSON value.</returns>
    ...
    /// </exception>
    public static Config? LoadJson(string json, JsonSerializerOptions? options = default)
        => JsonSerializer.Deserialize<Config>(json, options);

    /// <summary>
    /// Creates a new instance of the <see cref="Config"/> class from the UTF-8 encoded text representing a single JSON value.
    /// </summary>
    ...
    /// </exception>
    public static Config? LoadJson(System.IO.Stream utf8Json, JsonSerializerOptions? options = default)
        => JsonSerializer.Deserialize<Config>(utf8Json, options);
    ...
    /// There is remaining data in the string beyond a single JSON value.
    /// </exception>
    public static Config? LoadJson(ReadOnlySpan<char> json, JsonSerializerOptions? options = default)
        => JsonSerializer.Deserialize<Config>(json, options);
    ...
    /// The JSON is invalid, or there is remaining data in the Stream.
    /// </exception>
    public static Config? LoadJson(ReadOnlySpan<byte> utf8Json, JsonSerializerOptions? options = default)
        => JsonSerializer.Deserialize<Config>(utf8Json, options);
